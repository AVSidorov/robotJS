...
// ground
const mesh = new THREE.Mesh( new THREE.PlaneGeometry( 1, 1 ), new THREE.MeshPhongMaterial( { color: 0x555555, depthWrite: false } ) );
...
// folder_pos.add(robot_pose, "A1").listen().decimals(3);
// folder_pos.add(robot_pose, "A2").listen().decimals(3);
// folder_pos.add(robot_pose, "A3").listen().decimals(3);
// folder_pos.add(robot_pose, "A4").listen().decimals(3);
// folder_pos.add(robot_pose, "A5").listen().decimals(3);
// folder_pos.add(robot_pose, "A6").listen().decimals(3)   ;
